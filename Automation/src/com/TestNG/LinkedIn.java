...
public class LinkedIn {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement searchLocation = driver.findElement(By.xpath("/html/body/div[5]/div[3]/div[3]/div/div/section/div[2]/div[1]/div/div[3]/div[2]/div/input"));
		act.moveToElement(searchLocation);
		act.click().perform();
		searchLocation.sendKeys("canada");
				
		WebElement searchButton = driver.findElement(By.xpath("/html/body/div[5]/div[3]/div[3]/div/div/section/div[2]/div[1]/div/button"));
		act.moveToElement(searchButton);
		act.click().perform();
		
		WebElement linkedInFeatures = driver.findElement(By.xpath("/html/body/div[5]/div[3]/div[3]/section[1]/header/div/div/div[3]/div/div/ul/li[2]/form/button"));
		linkedInFeatures.click();
		
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		
		List<WebElement> linkedInFeaturesElements = driver.findElements(By.name("linkedin-features-group"));
		System.out.println(linkedInFeaturesElements.size());		
		
		/*for(int i=0; i<linkedInFeaturesElements.size(); i++)
		{
			String linkedInFeatureName = linkedInFeaturesElements.get(i).getAttribute("search-s-facet-value__name t-14 t-black--light t-normal");
			System.out.println(linkedInFeatureName);
		}*/
		
		/*WebElement easyApply = driver.findElement(By.xpath(String.format("//label[.='Easy Apply']","f_AL")));
		easyApply.click();
		*/
